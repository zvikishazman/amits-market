    ...
    <div className="min-h-screen relative overflow-hidden bg-[#0a0a0f]">
      ...
      <main className="relative z-10">
        <section className="flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-8 sm:pt-16 md:pt-24 pb-16 sm:pb-20">
          ...
          <div className="animate-fade-in">
            <div className="inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-500/20 text-xs sm:text-sm font-medium mb-8 sm:mb-10">
              ...
              <span className="text-blue-300">The Future of Social Predictions</span>
            </div>
          </div>
          ...
          <p className="mt-6 sm:mt-8 text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed animate-slide-up px-2" style={{ animationDelay: "0.15s" }}>
            Create private prediction markets with your inner circle.
            Bet on anything, watch odds shift in real-time, and prove you know best.
          </p>
          ...
          <div className="mt-12 sm:mt-16 flex items-center gap-6 sm:gap-8 md:gap-16 animate-slide-up" style={{ animationDelay: "0.35s" }}>
            {[
              { value: 1000, label: "Starting Balance", prefix: CURRENCY_SYMBOL },
              { value: 100, label: "Secure & Private", suffix: "%" },
              { value: 0, label: "Zero Fees", suffix: "" },
            ].map((stat) => (
              ...
              <div className="relative bg-gray-900/70 backdrop-blur-2xl border border-gray-700/50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-2xl shadow-blue-900/10">
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="text-[10px] sm:text-xs font-mono text-gray-400 uppercase tracking-widest">Live Market</span>
                  </div>
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-1 sm:mb-2">Who will win the championship?</h3>
                <p className="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6">Created by Alex &middot; 12 bettors &middot; Closes in 3 days</p>
                ...
                <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-800/50 flex items-center justify-between">
                  <div className="flex items-center gap-4 sm:gap-6">
                    <div>
                      <div className="text-[10px] sm:text-xs text-gray-500">Total Pool</div>
                      <div className="text-base sm:text-lg font-mono font-bold text-white">{CURRENCY_SYMBOL}2,450</div>
                    </div>
                    <div>
                      <div className="text-[10px] sm:text-xs text-gray-500">Your Potential</div>
        ...
        <section id="how-it-works" className="px-4 sm:px-6 pb-16 sm:pb-24 max-w-6xl mx-auto">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-gray-400 mt-3 sm:mt-4 max-w-lg mx-auto text-sm sm:text-base">Three simple steps to start predicting with friends</p>
          </div>
            ...
            {[
              {
                ...
                description: "Start a private group in seconds. Set the starting balance and share the unique invite code with your friends.",
                icon: (
              ...
              },
              {
                ...
                description: "Ask anything - who wins the game, will it rain, who arrives late. Add options and let the market decide the odds.",
                icon: (
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              },
              {
                step: "03",
                title: "Bet & Win",
                description: "Place your bets, watch odds shift live as friends pile in. When the answer is revealed, winners take the pool.",
                icon: (
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div key={item.step} className="relative group">
                ...
                <div className="relative glass p-6 sm:p-8 h-full transition-all duration-300 hover:border-blue-500/30 hover:translate-y-[-2px]">
                  <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/10 flex items-center justify-center text-blue-400">
                      {item.icon}
                    </div>
            ...
            {[
              {
                ...
                desc: "Every group is invite-only with unique encrypted codes. Your predictions stay between friends.",
                icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
              },
              {
                color: "blue",
                title: "Real-Time Odds",
                desc: "Watch probabilities shift instantly as bets come in. Powered by a parimutuel system used by the pros.",
                icon: "M13 10V3L4 14h7v7l9-11h-7z",
              },
              {
                color: "purple",
                title: "Fair Payouts",
                desc: "Winners split the entire pool proportionally. The earlier and more accurately you predict, the more you earn.",
                icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
              },
              {
                color: "amber",
                title: "Bet on Anything",
                desc: "Sports, weather, office bets, personal challenges - if you can ask a question, you can create a market.",
          ...
          <div className="relative">
            ...
            <div className="relative glass p-8 sm:p-12 md:p-16">
              ...
              <p className="text-gray-400 mb-6 sm:mb-8 max-w-md mx-auto text-sm sm:text-base">
                Join now and get {CURRENCY_SYMBOL}1,000 to start betting with your friends. No credit card needed.
              </p>
      ...
      <footer className="relative z-10 border-t border-gray-800/50 py-6 sm:py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <Logo />
          <p className="text-xs sm:text-sm text-gray-600">&copy; 2024 Amit&apos;s Market. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
